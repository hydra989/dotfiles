...
(defvar *transparency* nil)	;; set to true by default in exwm.init
...
(when *exwm-enabled*
  (load-config-file '( "src/exwm.init.el" )))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode cyberpunk-theme treemacs yaml-mode writeroom-mode use-package undo-fu treemacs-magit treemacs-evil pretty-hydra multiple-cursors multi-vterm monokai-pro-theme mini-modeline map lsp-jedi linum-relative impatient-mode grip-mode fountain-mode flycheck exwm evil-commentary elpy desktop-environment counsel cfrs ccls base16-theme avy auto-sudoedit all-the-icons))
